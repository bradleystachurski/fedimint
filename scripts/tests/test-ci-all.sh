...
function repro_stuck_rbf() {
  fm-run-test "${FUNCNAME[0]}" ./scripts/tests/repro-stuck-rbf.sh
}
export -f repro_stuck_rbf
...
parallel_args+=(--timeout "${FM_TEST_CI_ALL_TIMEOUT:-60}")
